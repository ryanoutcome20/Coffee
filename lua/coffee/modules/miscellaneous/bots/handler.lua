...
Coffee:LoadFile( 'lua/coffee/modules/miscellaneous/bots/other/handler.lua' )
Coffee:LoadFile( 'lua/coffee/modules/miscellaneous/bots/spawnbots/handler.lua' )

Coffee:LoadFile( 'lua/coffee/modules/miscellaneous/bots/walkbots/simple/handler.lua' )
Coffee:LoadFile( 'lua/coffee/modules/miscellaneous/bots/walkbots/point/handler.lua' )
